  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#6C3CE1] via-[#6940D8] to-[#00A9CC] px-6 py-16 text-center shadow-2xl shadow-violet-200/40 sm:px-10 sm:py-20 lg:px-16">
          {/* Decorative Elements */}
          <div
          ...
          <div className="relative mx-auto max-w-3xl">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-white/80 sm:text-lg sm:leading-8">
              Learn with us, build with us, explore opportunities, or simply
              stay connected as Hruwin grows.
            </p>
